    ...
    var Item = Base.extend(Emitter, {
        ...
        new function () {
            ...
            _hitTest: function (point, options, parentViewMatrix) {
                ...
                if (!point || !this._children && !this.getBounds({internal: true, stroke: true, handle: true})
        ...
        !function (e, r) {
            ...
            function u() {
                for (; pe > be;) {
                    ...
                    if (32 === e) ++be; else if (13 === e) {
                        ++be;
                        var r = de.charCodeAt(be);
                        10 === r && ++be, fe.locations && (++Ae, Se = be)
                    } else if (10 === e || 8232 === e || 8233 === e) ++be, fe.locations && (++Ae, Se = be); else if (e > 8 && 14 > e) ++be; else if (47 === e) {
            ...
            function k() {
                for (var e, r, n = "", a = be; ;) {
                    ...
                    var o = de.charAt(be);
                    if (Gr.test(o) && t(a, "Unterminated regular expression"), e) e = !1; else {
            ...
            function A(e) {
                ...
                for (var r = ""; ;) {
                    ...
                    if (92 === n) {
                        ...
                        if ("0" === a && (a = null), ++be, a) Oe && t(be - 2, "Octal literal in strict mode"), r += String.fromCharCode(parseInt(a, 8)), be += a.length - 1; else switch (n) {
                            case 110:
                                r += "\n";
                                break;
                            case 114:
                            ...
                            case 48:
                                ...
                                break;
                            case 13:
                                10 === de.charCodeAt(be) && ++be;
                            case 10:
                                fe.locations && (Se = be, ++Ae);
                                break;
                            default:
            ...
            function I() {
                ...
                for (var e, r = !0, n = be; ;) {
                    ...
                    if (Yr(a)) Br && (e += de.charAt(be)), ++be; else {
                        if (92 !== a)break;
            ...
            function J() {
                ...
                switch (e) {
                    ...
                    case We:
                        return U(), M(), q(r, "DebuggerStatement");
                    case Pe:
                    ...
                    case _e:
                        ...
                        var i = K(!1, !0);
                        return D(ur) ? (N(i), _(r, i)) : $(r, i);
                    case Ge:
                        return U(), ce(r, !0);
                    case Ke:
                        return U(), r.test = P(), r.consequent = J(), r.alternate = D(He) ? J() : null, q(r, "IfStatement");
                    case Qe:
                    ...
                    case Ye:
                        ...
                        return s && q(s, "SwitchCase"), U(), Re.pop(), q(r, "SwitchStatement");
                    case Ze:
                    ...
                    case rr:
                        return U(), G(r), M(), q(r, "VariableDeclaration");
                    case tr:
                        return U(), r.test = P(), Re.push(Zr), r.body = J(), Re.pop(), q(r, "WhileStatement");
                    case nr:
                        return Oe && t(ye, "'with' in strict mode"), U(), r.object = P(), r.body = J(), q(r, "WithStatement");
                    case pr:
                        return H();
                    case yr:
                    ...
                    default:
                        ...
                        if (e === De && "Identifier" === d.type && D(gr)) {
                            ...
                            return Re.push({
                                name: f,
                                kind: p
                            }), r.body = J(), Re.pop(), r.label = d, q(r, "LabeledStatement")
                        }
            ...
            function re() {
                if (we.prefix) {
                    var e = V(), r = we.isUpdate;
                    return e.operator = Ce, e.prefix = !0, Ee = !0, U(), e.argument = re(), r ? N(e.argument) : Oe && "delete" === e.operator && "Identifier" === e.argument.type && t(e.start, "Deleting local variable in strict mode"), q(e, r ? "UpdateExpression" : "UnaryExpression")
                }
                for (var n = te(); we.postfix && !B();) {
                    var e = T(n);
                    e.operator = Ce, e.prefix = !1, e.argument = n, N(n), U(), n = q(e, "UpdateExpression")
                }
                return n
            }
            ...
            function ne(e, r) {
                if (D(xr)) {
                    var t = T(e);
                    return t.object = e, t.property = le(!0), t.computed = !1, ne(q(t, "MemberExpression"), r)
                }
                if (D(fr)) {
                    var t = T(e);
                    return t.object = e, t.property = K(), t.computed = !0, z(dr), ne(q(t, "MemberExpression"), r)
                }
                if (!r && D(hr)) {
                    var t = T(e);
                    return t.callee = e, t.arguments = ue(vr, !1), ne(q(t, "CallExpression"), r)
                }
                return e
            }
            ...
            function ae() {
                switch (we) {
                    ...
                    case qe:
                        var e = V();
                        return e.value = Ce, e.raw = de.slice(ye, ge), U(), q(e, "Literal");
                    case ir:
                    case sr:
                    case cr:
                        var e = V();
                    ...
                    case fr:
                        var e = V();
                        return U(), e.elements = ue(dr, !0, !0), q(e, "ArrayExpression");
                    case pr:
                        return ie();
                    case Ge:
                        var e = V();
            ...
            function ie() {
                ...
                for (e.properties = [], U(); !D(mr);) {
                    if (r) r = !1; else if (z(br), fe.allowTrailingCommas && D(mr))break;
                    var a, o = {key: se()}, i = !1;
            ...
            function ue(e, r, t) {
                for (var n = [], a = !0; !D(e);) {
                    if (a) a = !1; else if (z(br), r && fe.allowTrailingCommas && D(e))break;
            ...
            e.tokenize = function (e, t) {
                ...
                de = String(e), pe = de.length, r(t), o();
                var a = {};
            ...
            var be, ye, ge, xe, ke, we, Ce, Ee, Ae, Se, Ie, Le, Ue, Fe, Re, Oe, Ve = [], Te = {type: "num"}, qe = {type: "regexp"}, je = {type: "string"}, De = {type: "name"}, Be = {type: "eof"}, Me = {keyword: "break"}, ze = {
                keyword: "case",
                beforeExpr: !0
            }, Xe = {keyword: "catch"}, Ne = {keyword: "continue"}, We = {keyword: "debugger"}, Je = {keyword: "default"}, Pe = {
                keyword: "do",
                isLoop: !0
            }, He = {keyword: "else", beforeExpr: !0}, $e = {keyword: "finally"}, _e = {
                keyword: "for",
                isLoop: !0
            }, Ge = {keyword: "function"}, Ke = {keyword: "if"}, Qe = {
                keyword: "return",
                beforeExpr: !0
            }, Ye = {keyword: "switch"}, Ze = {
                keyword: "throw",
                beforeExpr: !0
            }, er = {keyword: "try"}, rr = {keyword: "var"}, tr = {
                keyword: "while",
                isLoop: !0
            }, nr = {keyword: "with"}, ar = {
                keyword: "new",
                beforeExpr: !0
            }, or = {keyword: "this"}, ir = {keyword: "null", atomValue: null}, sr = {
                keyword: "true",
                atomValue: !0
            }, cr = {keyword: "false", atomValue: !1}, ur = {
                keyword: "in",
                binop: 7,
                beforeExpr: !0
            }, lr = {
            ...
            }, fr = {type: "[", beforeExpr: !0}, dr = {type: "]"}, pr = {
                type: "{",
                beforeExpr: !0
            }, mr = {type: "}"}, hr = {type: "(", beforeExpr: !0}, vr = {type: ")"}, br = {
                type: ",",
                beforeExpr: !0
            }, yr = {type: ";", beforeExpr: !0}, gr = {type: ":", beforeExpr: !0}, xr = {type: "."}, kr = {
                type: "?",
                beforeExpr: !0
            }, wr = {binop: 10, beforeExpr: !0}, Cr = {isAssign: !0, beforeExpr: !0}, Er = {
                isAssign: !0,
                beforeExpr: !0
            }, Ar = {postfix: !0, prefix: !0, isUpdate: !0}, Sr = {prefix: !0, beforeExpr: !0}, Ir = {
                binop: 1,
                beforeExpr: !0
            }, Lr = {binop: 2, beforeExpr: !0}, Ur = {binop: 3, beforeExpr: !0}, Fr = {
                binop: 4,
                beforeExpr: !0
            }, Rr = {binop: 5, beforeExpr: !0}, Or = {binop: 6, beforeExpr: !0}, Vr = {
                binop: 7,
                beforeExpr: !0
            }, Tr = {binop: 8, beforeExpr: !0}, qr = {binop: 9, prefix: !0, beforeExpr: !0}, jr = {
                binop: 10,
                beforeExpr: !0
            };
            e.tokTypes = {
